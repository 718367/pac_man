...
MainMenu::MainMenu(float width, float height) 
{
	...
	Mainmenupic.loadFromFile("hopefully.png");
	...
	menuchoice[0].setCharacterSize(110);
	menuchoice[0].setPosition(Vector2f(width /4 - 320 , height / 4 + 50));

	menuchoice[1].setFont(font);
	menuchoice[1].setFillColor(Color{ 255,255,255 });
	menuchoice[1].setString("leaderboard");
	menuchoice[1].setCharacterSize(100);
	menuchoice[1].setPosition(Vector2f(width / 4 - 400, height / 4 + 300));

	menuchoice[2].setFont(font);
	menuchoice[2].setFillColor(Color{ 255,255,255 });
	menuchoice[2].setString("options");
	menuchoice[2].setCharacterSize(110);
	menuchoice[2].setPosition(Vector2f(width / 4 - 350, height / 4 + 650));

	menuchoice[3].setFont(font);
	menuchoice[3].setFillColor(Color{ 255,255,255 });
	menuchoice[3].setString("Exit");
	menuchoice[3].setCharacterSize(110);
	menuchoice[3].setPosition(Vector2f(width / 4 - 300, height / 4 + 1000));
...
int MainMenu::playername(RenderWindow& window, string &username)
{
	...
	t1.setCharacterSize(95);
	t1.setPosition(Vector2f(1150 , 700));
	
	t2.setFillColor(Color{ 255,255,255 });
	t2.setCharacterSize(95);
	t2.setPosition(Vector2f(1100, 1100));
	t2.setFont(font);
